package WebServices.SOAP.SOAP.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
	...
	public XwsSecurityInterceptor securityInterceptor() {
		...
		securityInterceptor.setPolicyConfiguration(new ClassPathResource("securutyPolicy.xml"));
	...
	public SimplePasswordValidationCallbackHandler callbackHandler() {
		...
		handler.setUsersMap(Collections.singletonMap("gf","123"));
		return handler;
	}
